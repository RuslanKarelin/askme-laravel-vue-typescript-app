        ...
        <form method="POST" action="{{route('questions.store')}}">
            ...
            <div class="form-inputs clearfix">
                <p>
                    ...
                    <input type="text" name="title" class="form-input ml" value="{{old('title')}}">
                ...
                <p>
                    <label>Tags</label>
                    <input type="text" class="input" name="tags" value="{{old('tags')}}" id="question_tags"
                           data-seperator=",">
            ...
            <div id="form-textarea">
                <p>
                    ...
                    <textarea id="question-details" name="detail" aria-required="true" cols="58" rows="8">{{old('detail')}}</textarea>
